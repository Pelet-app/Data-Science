# SkillBridge AI — Data Science Project

Proyek Data Science untuk aplikasi **SkillBridge AI**, sistem rekomendasi pekerjaan berbasis AI yang menghubungkan pelamar kerja dengan jabatan yang paling sesuai berdasarkan standar kompetensi SKKNI dan data pasar kerja nyata Indonesia.
...
|---|---|---|---|
| Q2 | Berapa jumlah unit kompetensi masing-masing jabatan di SKKNI? Job mana yang paling kompleks? | SKKNI | Jumlah unit kompetensi unik per jabatan |
| Q4 | Skill apa yang paling sering diminta perusahaan di Indonesia saat ini? | JobStreet Indonesia | Frekuensi kemunculan skill di lowongan kerja |
| Q8 | Seberapa besar kesenjangan antara kompetensi standar SKKNI dengan kebutuhan industri nyata? | Gabungan | % skill SKKNI yang relevan dengan industri |
...
| Data Training Model | Google / sumber publik | Download dataset publik + cleaning manual | `cleaned_training_data.csv` |
...
**Data Training (`cleaned_training_data.csv`)**
...
### Q8 · Gap Analysis SKKNI vs Industri
...
| Q2 · Unit Kompetensi | Bar chart kompleksitas jabatan + tabel detail unit | SKKNI |
| Q4 · Skill Demand | Top N skill industri + pie chart tipe pekerjaan + metrik pengalaman | JobStreet |
| Q8 · Gap Analysis | % relevansi per jabatan + tabel skill yang gap | Gabungan |
...
![Hasil A/B Testing](ab_testing/ab_testing_result.png)
...
📄 **`laporan/Laporan_Teknis_SkillBridge_AI.pdf`**
...
│   └── cleaned_training_data.csv      # Dataset training model (sudah di-cleaning)
│
├── dashboard/
...
│   ├── ab_testing_result.png          # Visualisasi hasil eksperimen
│   └── README_abtesting.md            # Dokumentasi A/B Testing
│
├── laporan/
